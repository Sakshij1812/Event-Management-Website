            ...
            <form method="post">
          	<div id="reg">
	          	<section class="jumbotron text-center">
		            <div class="container">
			            <h1 class="jumbotron-heading">Thank You!</h1><br>
			            <p> Your request for the booking Id <?php echo $_SESSION['bookid']; ?> has been submitted. You will be contacted by our team shortly.</p>
		          	</div><br>
